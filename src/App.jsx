...
function App(){
 const [applications, setApplications] = useState([]);
  ...
  try {
    await axios.post(
      "https://placement-pro-backend-e8vkun7jo-nishitha-rai.vercel.app/applications",
      newApplication
    );
...
const deleteApplication = async (id) => {
  try {
    await axios.delete(`https://placement-pro-backend-e8vkun7jo-nishitha-rai.vercel.app/applications/${id}`);
...
useEffect(() => {
  axios
    .get("https://placement-pro-backend-e8vkun7jo-nishitha-rai.vercel.app/applications")
    .then((response) => {
      setApplications(response.data);
    })
    .catch((error) => {
